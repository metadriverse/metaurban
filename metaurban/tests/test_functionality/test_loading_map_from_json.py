...
from metaurban.utils import recursive_equal
from metaurban.utils.pg.generate_maps import generate_maps
...
def _test_loaded_map_alignment():
    ...
    for seed in [0, 1, 2, 99]:
        ...
        generate_maps(metaurbanEnv, env_config.copy(), json_file_path="seed{}_v1.json".format(seed))
        # generate_maps(metaurbanEnv, env_config.copy(), json_file_path="seed{}_v2.json".format(seed))
