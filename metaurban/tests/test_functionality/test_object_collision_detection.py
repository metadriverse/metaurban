...
from metaurban.component.vehicle.vehicle_type import LVehicle
from metaurban.constants import TerminationState, DEFAULT_AGENT
...
class ComplexObjectManager(TrafficObjectManager):
    def reset(self):
        ...
        self.engine.object_manager.accident_lanes.append(lane)
        from metaurban.component.vehicle.vehicle_type import SVehicle, XLVehicle
        v_pos = [8, 14]
...
class ComplexEnv(SafemetaurbanEnv):
    """
