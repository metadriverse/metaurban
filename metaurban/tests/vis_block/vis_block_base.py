...
from metaurban.engine.asset_loader import close_asset_loader
...
from metaurban.component.algorithm.BIG import NextStep
from metaurban.component.map.base_map import BaseMap
from metaurban.constants import BKG_COLOR
