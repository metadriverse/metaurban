...
class ModifiedEnv(SidewalkStaticMetaUrbanEnv):
    def _get_agent_manager(self):
        from metaurban.manager.agent_manager import VelDeliveryRobotAgentManager
        return VelDeliveryRobotAgentManager(init_observations=self._get_observations())
...
if __name__ == "__main__":
    ...
    config = dict(
        ...
        agent_type='coco', #['coco'] only coco is supported in this script
    ...
    try:
        ...
        for i in range(1, 1000000000):
            ...
            o, r, tm, tc, info = env.step([1., 0.01])  ### reset; get next -> empty -> have multiple end points
