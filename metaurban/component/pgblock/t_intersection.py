from metaurban.component.pgblock.intersection import InterSection
from metaurban.component.pgblock.pg_block import PGBlockSocket
from metaurban.component.road_network import Road
from metaurban.constants import Goal, PGLineType, PGLineColor
    ...
    def _change_vis(self, t_type):
        ...
        for i, road in enumerate([Road(last_negative.end_node, next_positive.start_node),
            ...
            for k, lane in enumerate(lanes):
                ### change_on_0516 ### # change NONE to BROKEN
                line_types = [PGLineType.BROKEN, PGLineType.NONE
