...
from metaurban.utils.math import norm, mph_to_kmh
from metaurban.scenario.utils import read_scenario_data
...
class ScenarioLane(PointLane):
    ...
    def __init__(self, lane_id: int, map_data: dict, need_lane_localization):
        ...
        super(ScenarioLane, self).__init__(
            ...
            metaurban_type=map_data[lane_id][ScenarioDescription.TYPE]
        )
        self.index = lane_id
