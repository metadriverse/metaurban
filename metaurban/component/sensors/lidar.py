...
from metaurban.component.sensors.distance_detector import DistanceDetector
    ...
    def get_surrounding_vehicles_info(
        ...
        for vehicle in surrounding_vehicles[:num_others]:
            if vehicle is not None:
                ...
                # assert isinstance(vehicle, IDMVehicle or Base), "Now metaurban Doesn't support other vehicle type"
