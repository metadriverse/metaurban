...
from metaurban.component.pg_space import Parameter, BlockParameterSpace
...
from metaurban.utils import clip, norm, get_np_random
from metaurban.utils.math import panda_vector
from metaurban.utils.pg.utils import ray_localization
...
class NodeNetworkNavigation(BaseNavigation):
    ...
    def reset(self, vehicle):
        ...
        if len(possible_lanes) == 0 and vehicle.config["spawn_lane_index"] is None:
            from metaurban.utils.error_class import NavigationError
