...
from metaurban.component.road_network.base_road_network import BaseRoadNetwork
from metaurban.component.road_network.base_road_network import LaneIndex
from metaurban.scenario.scenario_description import ScenarioDescription as SD
from metaurban.utils.math import get_boxes_bounding_box
from metaurban.utils.pg.utils import get_lanes_bounding_box
    ...
    def get_map_features(self, interval=2):
        ...
        for id, lane_info in self.graph.items():
            ...
            ret[id] = {
                ...
                SD.TYPE: lane_info.lane.metaurban_type,
