...
def main():
    ...
    from metaurban.third_party.kitsunetsuki.exporter.gltf import GLTFExporter
...
def register(init_version):
    ...
    from metaurban.third_party.kitsunetsuki.exporter.gltf import GLTFExporterOperator, export
