...
def main():
    ...
    from metaurban.third_party.kitsunetsuki.exporter.vrm import VRMExporter
...
def register(init_version):
    ...
    from metaurban.third_party.kitsunetsuki.exporter.vrm import VRMExporterOperator, export
