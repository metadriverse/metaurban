...
from metaurban.constants import Decoration, DEFAULT_AGENT
from metaurban.obs.top_down_obs import TopDownObservation
from metaurban.obs.top_down_obs_impl import WorldSurface, COLOR_BLACK, ObjectGraphics, LaneGraphics, \
    ObservationWindowMultiChannel
from metaurban.utils import import_pygame, clip
...
from metaurban.component.navigation_module.edge_network_navigation import EdgeNetworkNavigation
from metaurban.component.navigation_module.trajectory_navigation import TrajectoryNavigation
...
class TopDownMultiChannel(TopDownObservation):
    """
    Most of the source code is from Highway-Env, we only optimize and integrate it in metaurban
