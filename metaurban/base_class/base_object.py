...
from metaurban.constants import ObjectState
...
from metaurban.utils import Vector
from metaurban.utils import get_np_random
from metaurban.utils import random_string
from metaurban.utils.coordinates_shift import panda_vector, metaurban_vector, panda_heading
from metaurban.utils.math import clip
...
class BaseObject(BaseRunnable, MetaUrbanType, ABC):
    """
    ...
    @property
    def position(self):
        return metaurban_vector(self.origin.getPos())
