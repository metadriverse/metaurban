...
from metaurban.component.traffic_light.scenario_traffic_light import ScenarioTrafficLight
...
class ScenarioLightManager(BaseManager):
    ...
    def _get_episode_light_data(self):
        ...
        for lane_id, light_info in self.current_scenario[SD.DYNAMIC_MAP_STATES].items():
            ...
            assert light_info[SD.TYPE] == MetaUrbanType.TRAFFIC_LIGHT, "Can not handle {}".format(light_info[SD.TYPE])
        return ret
