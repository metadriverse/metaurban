...
from metaurban.scenario.scenario_description import ScenarioDescription as SD, MetaUrbanType
from metaurban.scenario.utils import read_scenario_data, read_dataset_summary
...
class ScenarioDataManager(BaseManager):
    ...
    def sort_scenarios(self):
        ...
        def _score(scenario_id):
            ...
            num_moving_objs = SD.num_moving_object(scenario, object_type=MetaUrbanType.VEHICLE)
