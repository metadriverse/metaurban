...
from metaurban.constants import Decoration, MetaUrbanType
from metaurban.engine.physics_node import BaseRigidBodyNode, BaseGhostBodyNode
from metaurban.utils.coordinates_shift import panda_heading
...
from metaurban.utils.math import get_points_bounding_box, norm
from metaurban.utils.utils import get_object_from_node

if TYPE_CHECKING:
    from metaurban.component.pgblock.pg_block import PGBlockSocket
...
def generate_static_box_physics_body(
    ...
    ghost_node=False,
    object_id=None,
    type_name=MetaUrbanType.INVISIBLE_WALL,
