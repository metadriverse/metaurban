...
from metaurban.constants import CamMask, Semantics, MapTerrainSemanticColor
from metaurban.constants import MetaUrbanType, CollisionGroup
from metaurban.constants import TerrainProperty, CameraTagStateKey
from metaurban.engine.asset_loader import AssetLoader
from metaurban.engine.logger import get_logger
from metaurban.third_party.diamond_square import diamond_square
...
class Terrain(BaseObject, ABC):
    ...
    def generate_plane_collision_terrain(self):
        ...
        node = BulletRigidBodyNode(MetaUrbanType.GROUND)
        node.setFriction(.9)
        node.addShape(shape)
    ...
    def get_terrain_semantics(self, center_point):
        ...
        if self.engine.current_map:
            ...
            lane_color = MapTerrainSemanticColor.get_color(MetaUrbanType.LANE_SURFACE_STREET)
