...
this script. Installation guide:
    ...
    pip install ray[rllib]==2.2.0 tensorflow_probability==0.24.0 protobuf==3.20.0 numpy==1.22.0
...
def get_train_parser():
    ...
    parser.add_argument("--exp-name", type=str, default="ray_experiment")
...
if __name__ == '__main__':
    ...
    config = dict(
        ...
        env=createGymWrapper(SidewalkStaticMetaUrbanEnv),
        env_config=dict(
